...
pingpong_net_vector <- read.csv("evaluation/data/pingpong-net-10-pings-vec.out", sep=",", as.is=c(numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric))
