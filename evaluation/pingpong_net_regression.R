...
pingpong_net_10 <- read.csv("evaluation/regression/pingpong-tcp-net-10-runs.out", sep=",", as.is=c(numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric))
pingpong_net_10$avg <- rowMeans(pingpong_net_10[,2:11])
pingpong_net_10$avg <- pingpong_net_10$avg/1000
pingpong_net_10$sdev <- apply(pingpong_net_10[,2:11], 1, sd)
pingpong_net_10$sdev <- pingpong_net_10$sdev/1000
pingpong_net_10$proto <- 'libcaf_net'

ppdf <- rbind(pingpong_net)
