...
pingpong_io <- read.csv("evaluation/out/pingpong-tcp-io-message-size.out", sep=",", as.is=c(numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric))
...
pingpong_net <- read.csv("evaluation/out/pingpong-tcp-net-message-size.out", sep=",", as.is=c(numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric))
...
pp_plot_log <- ggplot(ppdf, aes(x=message_size, y=avg, color=proto)) +
  geom_line() + # size=0.8) +
...
ggsave("figs/pingpong-message-size-log-scale.pdf", plot=pp_plot_log, width=4, height=3)
