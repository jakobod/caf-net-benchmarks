...
pingpong_net_vector_fetch <- read.csv("evaluation/data/pingpong-multiple-100-pings-vectored-fetch-more-net.out", sep=",", as.is=c(numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric))
