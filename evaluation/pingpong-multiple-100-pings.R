...
pingpong_net_single_buf_fetch <- read.csv("evaluation/data/pingpong-100-ping-single-buf-fetch-1-net.out", sep=",", as.is=c(numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric))
...
pingpong_net_single_buf_fetch_20 <- read.csv("evaluation/data/pingpong-100-ping-single-buf-fetch-20-net.out", sep=",", as.is=c(numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric))
...
pingpong_net_vector_fetch_20 <- read.csv("evaluation/data/pingpong-multiple-100-pings-vectored-fetch-20-net.out", sep=",", as.is=c(numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric))
...
ppdf <- rbind(pingpong_net_master, pingpong_net_vector, pingpong_net_single_buf_fetch, pingpong_net_vector_fetch_20, pingpong_net_single_buf_fetch_20, pingpong_io)
...
pp_plot <- ggplot(ppdf, aes(x=num_pings, y=avg, color=proto)) +
  ...
  scale_y_continuous(labels = human_numbers, limits=c(60000,300000), breaks=seq(60000, 300000, 10000)) + # expand=c(0, 0), limits=c(0, 10)
  theme_bw() +
  theme(
