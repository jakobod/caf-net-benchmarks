...
pp_plot <- ggplot(ppdf, aes(x=num_pings, y=avg, color=proto)) +
  ...
  scale_y_continuous(labels = human_numbers, limits=c(0,30000), breaks=seq(0, 30000, 5000)) + # expand=c(0, 0), limits=c(0, 10)
  theme_bw() +
  theme(
...
ggsave("figs/pingpong-without-io.pdf", plot=pp_plot, width=5, height=3)
